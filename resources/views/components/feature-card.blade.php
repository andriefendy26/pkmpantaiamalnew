...
<a href="{{ $href }}" class="group flex flex-col rounded-2xl border {{ $w['border'] }} {{ $w['bg'] }} {{ $w['hover'] }} p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
    @if ($image)
    ...
    <p class="text-sm leading-relaxed text-neutral-500 dark:text-neutral-400">{{ $short_description }}</p>
</a>
