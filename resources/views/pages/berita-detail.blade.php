...
@section('title', $berita->title . ' - UPTD Puskesmas Pantai Amal')
...
<div class="min-h-screen bg-white dark:bg-neutral-950 overflow-x-hidden">
    ...
    <div class="relative overflow-hidden border-b border-neutral-100 dark:border-neutral-800 bg-gradient-to-br from-emerald-50 via-white to-teal-50 dark:from-neutral-900 dark:via-neutral-950 dark:to-emerald-950/20">
        ...
        <div class="relative mx-auto max-w-7xl px-6 py-20 md:py-28">
            <div class="mx-auto max-w-3xl fade-in">
                <a href="{{ route('berita.index') }}" class="mb-6 inline-flex items-center gap-1 text-sm font-medium text-neutral-500 hover:text-emerald-600 dark:text-neutral-400 dark:hover:text-emerald-400">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm font-medium text-slate-800 dark:text-slate-100">{{ $berita->displayAuthorName() }}</p>
    ...
    <div class="mx-auto max-w-7xl px-6 py-12">
        <div class="mx-auto max-w-3xl">
            @if ($berita->thumbnail)
                <div class="mb-8 overflow-hidden rounded-2xl border border-neutral-200 dark:border-neutral-700">
                    <img src="{{ asset('storage/' . $berita->thumbnail) }}" alt="{{ $berita->title }}" class="w-full object-cover" />
                </div>
            @endif
        ...
        @if ($related->count() > 0)
            <div class="mt-16">
                <x-section-header label="Terkait" title="Berita Lainnya" />
